    ...
    value: function simulateGame(playerOne, playerTwo) {
      ...
      var _loop = function _loop(i) {
        ...
        players.forEach(function (player, index) {
          var currentGame = player.games[player.games.length - 1];
          var opponent = players.filter(function (filterPlayer) {
            return filterPlayer !== player;
          })[0];
          if (!opponent) {
        ...
        players.forEach(function (player, index) {
          ...
          var playerBetray = currentGame.history[i];
          ...
          if (opponent === player) {
            if (index === 0) {
              ...
              currentGame.score += _this.calcResult(playerBetray, opponentBetray);
            }
          } else {
            player.score += _this.calcResult(playerBetray, opponentBetray);
            currentGame.score += _this.calcResult(playerBetray, opponentBetray);
