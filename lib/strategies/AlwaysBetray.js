...
var AlwaysBetray = function (_Strategy) {
  _inherits(AlwaysBetray, _Strategy);

  function AlwaysBetray(name) {
    _classCallCheck(this, AlwaysBetray);

    return _possibleConstructorReturn(this, (AlwaysBetray.__proto__ || Object.getPrototypeOf(AlwaysBetray)).call(this, name));
  }
