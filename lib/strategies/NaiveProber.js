...
var NaiveProber = function (_Strategy) {
  _inherits(NaiveProber, _Strategy);

  function NaiveProber() {
    _classCallCheck(this, NaiveProber);

    var _this = _possibleConstructorReturn(this, (NaiveProber.__proto__ || Object.getPrototypeOf(NaiveProber)).call(this));

    _this.name = 'Naive Prober';
    return _this;
  }

  _createClass(NaiveProber, [{
    key: "play",
