...
var Pavlov = function (_Strategy) {
  _inherits(Pavlov, _Strategy);

  function Pavlov(name) {
    _classCallCheck(this, Pavlov);

    return _possibleConstructorReturn(this, (Pavlov.__proto__ || Object.getPrototypeOf(Pavlov)).call(this, name));
  }
