...
var TitForTwoTats = function (_Strategy) {
  _inherits(TitForTwoTats, _Strategy);

  function TitForTwoTats() {
    _classCallCheck(this, TitForTwoTats);

    var _this = _possibleConstructorReturn(this, (TitForTwoTats.__proto__ || Object.getPrototypeOf(TitForTwoTats)).call(this));

    _this.name = 'Tit for Two Tats';
    return _this;
  }

  _createClass(TitForTwoTats, [{
    key: "play",
