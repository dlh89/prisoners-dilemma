...
var RemorsefulProber = function (_Strategy) {
  _inherits(RemorsefulProber, _Strategy);

  function RemorsefulProber() {
    _classCallCheck(this, RemorsefulProber);

    var _this = _possibleConstructorReturn(this, (RemorsefulProber.__proto__ || Object.getPrototypeOf(RemorsefulProber)).call(this));

    _this.name = 'Remorseful Prober';
    return _this;
  }

  _createClass(RemorsefulProber, [{
    key: "play",
  ...
  return RemorsefulProber;
}(_Strategy3.default);

exports.default = RemorsefulProber;