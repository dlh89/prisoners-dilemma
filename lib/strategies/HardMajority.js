...
var HardMajority = function (_Strategy) {
  _inherits(HardMajority, _Strategy);

  function HardMajority() {
    _classCallCheck(this, HardMajority);

    var _this = _possibleConstructorReturn(this, (HardMajority.__proto__ || Object.getPrototypeOf(HardMajority)).call(this));

    _this.name = 'Hard Majority';
    return _this;
  }

  _createClass(HardMajority, [{
    key: "play",
